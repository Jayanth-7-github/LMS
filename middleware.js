...
export async function middleware(req) {
  ...
  // If a non-admin tries to access admin dashboard, redirect to their dashboard
  ...
  // If a non-student tries to access student dashboard, redirect to their dashboard
